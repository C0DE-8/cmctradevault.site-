  ...
  return (
    <section className={s.section} id="testimonials">
      <div className={s.sectionHeading}>
        ...
        <p>Perspectives from the CMC TradeVault community.</p>
      </div>
